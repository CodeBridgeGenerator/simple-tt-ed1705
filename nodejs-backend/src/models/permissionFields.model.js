  ...
  const schema = new Schema(
    {
      ...
      service: { type: String, required: false, unique: false, lowercase: false, uppercase: false, minLength: 2, maxLength: 150, index: true, trim: true },
      fieldId: { type: String, required: false, unique: false, lowercase: false, uppercase: false, minLength: 3, maxLength: 100000000, index: true, trim: true },
      read: { type: Boolean, required: false, default: true },
      readAll: { type: Boolean, required: false, default: true },
