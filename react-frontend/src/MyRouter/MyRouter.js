...
import SingleTestPage from "../components/TestPage/SingleTestPage";
import TestProjectLayoutPage from "../components/TestPage/TestProjectLayoutPage";
// ~cb-add-import~
  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute redirectPath={"/login"} />}>
        ...
        />
<Route path="/test/:singleTestId" exact element={<SingleTestPage />} />
<Route path="/test" exact element={<TestProjectLayoutPage />} />
