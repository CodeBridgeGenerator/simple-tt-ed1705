...
const UserAddressesPage = (props) => {
    ...
    const deleteRow = async () => {
        try {
            await client.service('userAddresses').remove(data[selectedEntityIndex]?._id);
    ...
    return (
        <div className="mt-5">
            ...
            <UserAddressesEditDialogComponent entity={data[selectedEntityIndex]} show={showEditDialog} onHide={() => setShowEditDialog(false)} onEditResult={onEditResult} />
            <UserAddressesCreateDialogComponent show={showCreateDialog} onHide={() => setShowCreateDialog(false)} onCreateResult={onCreateResult} />
