...
const DynaFieldsPage = (props) => {
    ...
    const deleteRow = async () => {
        try {
            await client.service('dynaFields').remove(data[selectedEntityIndex]?._id);
    ...
    return (
        <div className="mt-5">
            ...
            <DynaFieldsEditDialogComponent service={props.service} entity={data[selectedEntityIndex]} show={showEditDialog} onHide={() => setShowEditDialog(false)} onEditResult={onEditResult} />
            <DynaFieldsCreateDialogComponent service={props.service} show={showCreateDialog} onHide={() => setShowCreateDialog(false)} onCreateResult={onCreateResult} />
