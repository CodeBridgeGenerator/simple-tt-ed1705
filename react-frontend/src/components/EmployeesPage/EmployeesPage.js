...
const EmployeesPage = (props) => {
    ...
    useEffect(() => {
        let service = _.find(config.services, { serviceName: 'employees' });
        if (!service) {
            service = _.find(standard.services, { serviceName: 'employees' });
        }
    ...
    const deleteRow = async () => {
        try {
            await client.service('employees').remove(data[selectedEntityIndex]?._id);
        ...
        <div className="mt-5">
            <div className="grid">
                ...
                <div className="col-6 flex justify-content-end">
                    <>
                        <Button label="add" icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="employees-add-button" />
            ...
            <EmployeesEditDialogComponent entity={data[selectedEntityIndex]} show={showEditDialog} onHide={() => setShowEditDialog(false)} onEditResult={onEditResult} />
            <EmployeesCreateDialogComponent show={showCreateDialog} onHide={() => setShowCreateDialog(false)} onCreateResult={onCreateResult} />
