...
const PermissionFieldsCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Edit Permission Fields" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: '40vw' }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto" style={{ maxWidth: '55vw' }} role="permissionFields-edit-dialog-component">
                ...
                <div className="col-12 md:col-6 field mt-5">
                    <span className="align-items-center">
                        ...
                        <InputText id="fieldId" className="w-full mb-3 p-inputtext-sm" value={_entity?.fieldId} onChange={(e) => setValByKey('fieldId', e.target.value)} />
                    </span>
                </div>
                <div className="col-12 md:col-6 field mt-5">
                    <span className="align-items-center">
