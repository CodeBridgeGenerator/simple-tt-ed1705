...
import PermissionFieldsCreateDialogComponent from './PermissionFieldsCreateDialogComponent1';
...
const PermissionFieldsPage = (props) => {
        ...
        client
            ...
            .catch((error) => {
                ...
                props.alert({
                    ...
                    type: 'error',
                    message: error.message || 'Failed get Permission Fields'
                });
            });
    ...
    const deleteRow = async () => {
        try {
            await client.service('permissionFields').remove(data[selectedEntityIndex]?._id);
        ...
        <div className="mt-5">
            <div className="grid">
                <div className="col-6 flex justify-content-start">
                    <h3 className="mb-0 ml-2">Permission Fields </h3>
                </div>
                <div className="col-6 flex justify-content-end">
                    <>
                        <Button label="add" icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="permissionFields-add-button" />
            ...
            <PermissionFieldsEditDialogComponent entity={data[selectedEntityIndex]} show={showEditDialog} onHide={() => setShowEditDialog(false)} onEditResult={onEditResult} />
            <PermissionFieldsCreateDialogComponent show={showCreateDialog} onHide={() => setShowCreateDialog(false)} onCreateResult={onCreateResult} />
