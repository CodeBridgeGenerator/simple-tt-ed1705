...
const SuperiorPage = (props) => {
    ...
    const deleteRow = async () => {
        try {
            await client.service('superior').remove(data[selectedEntityIndex]?._id);
        ...
        <div className="mt-5">
            <div className="grid">
                ...
                <div className="col-6 flex justify-content-end">
                    <>
                        <Button label="add" icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="superior-add-button" />
            ...
            <SuperiorEditDialogComponent entity={data[selectedEntityIndex]} show={showEditDialog} onHide={() => setShowEditDialog(false)} onEditResult={onEditResult} />
