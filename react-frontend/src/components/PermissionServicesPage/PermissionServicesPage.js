...
import PermissionServicesEditDialogComponent from './PermissionServicesEditDialogComponent1';
import PermissionServicesCreateDialogComponent from './PermissionServicesCreateDialogComponent1';
...
const PermissionServicesPage = (props) => {
        ...
        client
            ...
            .catch((error) => {
                ...
                props.alert({
                    ...
                    type: 'error',
                    message: error.message || 'Failed get Permission Services'
                });
            });
    ...
    const deleteRow = async () => {
        try {
            await client.service('permissionServices').remove(data[selectedEntityIndex]?._id);
        ...
        <div className="mt-5">
            <div className="grid">
                <div className="col-6 flex justify-content-start">
                    <h3 className="mb-0 ml-2">Permission Services </h3>
                </div>
                <div className="col-6 flex justify-content-end">
                    <>
                        <Button label="add" icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="permissionServices-add-button" />
            ...
            <PermissionServicesEditDialogComponent entity={data[selectedEntityIndex]} show={showEditDialog} onHide={() => setShowEditDialog(false)} onEditResult={onEditResult} />
            <PermissionServicesCreateDialogComponent show={showCreateDialog} onHide={() => setShowCreateDialog(false)} onCreateResult={onCreateResult} />
