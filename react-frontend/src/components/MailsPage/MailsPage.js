...
const MailsPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .catch((error) => {
                console.log({ error });
                props.alert({ title: 'Mails', type: 'error', message: error.message || 'Failed get Mails' });
            });
    ...
    const deleteRow = async () => {
        try {
            await client.service('mails').remove(data[selectedEntityIndex]?._id);
            ...
            console.log({ error });
            props.alert({ title: 'Mails', type: 'error', message: error.message || 'Failed delete record' });
        }
    };
        ...
        <div className="mt-5">
            <div className="grid">
                <div className="col-6 flex justify-content-start">
                    <h3 className="mb-0 ml-2">Mails </h3>
                </div>
                <div className="col-6 flex justify-content-end">
                    <>
                        <Button label="add" icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="mails-add-button" />
            ...
            <MailsEditDialogComponent entity={data[selectedEntityIndex]} show={showEditDialog} onHide={() => setShowEditDialog(false)} onEditResult={onEditResult} />
            <MailsCreateDialogComponent show={showCreateDialog} onHide={() => setShowCreateDialog(false)} onCreateResult={onCreateResult} />
