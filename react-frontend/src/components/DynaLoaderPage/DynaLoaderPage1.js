...
const DynaLoaderPage = (props) => {
    ...
    const deleteRow = async () => {
        try {
            await client.service('dynaLoader').remove(data[selectedEntityIndex]?._id);
    ...
    return (
        <div className="mt-5">
            ...
            <DynaLoaderEditDialogComponent entity={data[selectedEntityIndex]} show={showEditDialog} onHide={() => setShowEditDialog(false)} onEditResult={onEditResult} />
            <DynaLoaderCreateDialogComponent data={data} show={showCreateDialog} onHide={() => setShowCreateDialog(false)} onCreateResult={onCreateResult} />
