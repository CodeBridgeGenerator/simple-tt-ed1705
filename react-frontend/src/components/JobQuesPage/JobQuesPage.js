...
const JobQuesPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .catch((error) => {
                console.log({ error });
                props.alert({ title: 'Job Ques', type: 'error', message: error.message || 'Failed get Job Ques' });
            });
    ...
    const deleteRow = async () => {
        try {
            await client.service('jobQues').remove(data[selectedEntityIndex]?._id);
            ...
            console.log({ error });
            props.alert({ title: 'Job Ques', type: 'error', message: error.message || 'Failed delete record' });
        }
    };
        ...
        <div className="mt-5">
            <div className="grid">
                ...
                <div className="col-6 flex justify-content-end">
                    <>
                        <Button label="add" icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="jobQues-add-button" />
            ...
            <JobQuesEditDialogComponent entity={data[selectedEntityIndex]} show={showEditDialog} onHide={() => setShowEditDialog(false)} onEditResult={onEditResult} />
            <JobQuesCreateDialogComponent show={showCreateDialog} onHide={() => setShowCreateDialog(false)} onCreateResult={onCreateResult} />
