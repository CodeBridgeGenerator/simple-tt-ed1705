...
const SingleJobQuesPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .catch((error) => {
                console.log({ error });
                props.alert({ title: 'JobQues', type: 'error', message: error.message || 'Failed get jobQues' });
            });
                    ...
                    <div className="grid ">
                        ...
                        <div className="col-12 md:col-6 lg:col-3">
                            ...
                            <p className="m-0 ml-3">
                                <Calendar id="start" value={new Date(_entity?.start)} timeOnly disabled={true} />
                            </p>
                        </div>
                        <div className="col-12 md:col-6 lg:col-3">
                            <label className="text-sm text-primary">End</label>
                            <p className="m-0 ml-3">
                                <Calendar id="end" value={new Date(_entity?.end)} timeOnly disabled={true} />
                            </p>
                        </div>
