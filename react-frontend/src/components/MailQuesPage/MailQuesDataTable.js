...
const MailQuesDataTable = ({
    ...
    const pTemplate3 = (rowData, { rowIndex }) => <p>{rowData.from}</p>;
    const pTemplate4 = (rowData, { rowIndex }) => <p>{rowData.recipients}</p>;
    const pTemplate5 = (rowData, { rowIndex }) => <p>{rowData.status}</p>;
    const pTemplate6 = (rowData, { rowIndex }) => <p>{rowData.errors}</p>;
    const pTemplate7 = (rowData, { rowIndex }) => <p>{rowData.template}</p>;
    const pTemplate8 = (rowData, { rowIndex }) => <p>{rowData.content}</p>;
    ...
    return (
        <>
            ...
            >
                ...
                <Column field="from" header="From" body={pTemplate3} filter={selectedFilterFields.includes('from')} hidden={selectedHideFields?.includes('from')} sortable style={{ minWidth: '8rem' }} />
                <Column field="recipients" header="Recipients" body={pTemplate4} filter={selectedFilterFields.includes('recipients')} hidden={selectedHideFields?.includes('recipients')} sortable style={{ minWidth: '8rem' }} />
                ...
                <Column field="errors" header="Errors" body={pTemplate6} filter={selectedFilterFields.includes('errors')} hidden={selectedHideFields?.includes('errors')} sortable style={{ minWidth: '8rem' }} />
                <Column field="template" header="Template" body={pTemplate7} filter={selectedFilterFields.includes('template')} hidden={selectedHideFields?.includes('template')} sortable style={{ minWidth: '8rem' }} />
                <Column field="content" header="Content" body={pTemplate8} filter={selectedFilterFields.includes('content')} hidden={selectedHideFields?.includes('content')} sortable style={{ minWidth: '8rem' }} />
